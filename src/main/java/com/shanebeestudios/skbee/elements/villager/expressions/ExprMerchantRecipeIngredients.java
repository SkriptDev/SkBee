...
@Since("1.17.0")
public class ExprMerchantRecipeIngredients extends SimpleExpression<ItemStack> {

    static {
        Skript.registerExpression(ExprMerchantRecipeIngredients.class, ItemStack.class, ExpressionType.SIMPLE,
    ...
    protected @Nullable ItemStack[] get(Event event) {
        ...
        if (pattern == 0) {
            ...
            recipe.getIngredients().forEach(itemStack -> items.add(itemStack));
    ...
    public void change(Event event, @Nullable Object[] delta, ChangeMode mode) {
        ...
        for (Object object : delta) {
            if (object instanceof ItemStack itemType) {
