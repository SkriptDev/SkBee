...
@Since("3.4.0")
public class ExprItemFlags extends PropertyExpression<ItemStack, ItemFlag> {

    static {
        register(ExprItemFlags.class, ItemFlag.class, "item[ ]flags", "itemstacks");
    }
    ...
    @Override
    protected ItemFlag @NotNull [] get(Event event, ItemStack[] source) {
        List<ItemFlag> itemFlags = new ArrayList<>();
        for (ItemStack itemType : source) {
