    ...
    static {
        ...
        if (Skript.classExists("com.destroystokyo.paper.event.player.PlayerElytraBoostEvent")) {
            ...
            EventValues.registerEventValue(PlayerElytraBoostEvent.class, ItemStack.class, new Getter<>() {
                @Override
                public ItemStack get(PlayerElytraBoostEvent e) {
        ...
        if (Skript.classExists("io.papermc.paper.event.player.PlayerStopUsingItemEvent")) {
            Skript.registerEvent("Player Stop Using Item", PaperEvents.class, PlayerStopUsingItemEvent.class, "[player] stop using item")
                ...
                .examples("on player stop using item:",
                    ...
                    "\t\tkill player")
                .since("1.17.0");
            EventValues.registerEventValue(PlayerStopUsingItemEvent.class, ItemStack.class, new Getter<>() {
                @Override
                public ItemStack get(PlayerStopUsingItemEvent event) {
