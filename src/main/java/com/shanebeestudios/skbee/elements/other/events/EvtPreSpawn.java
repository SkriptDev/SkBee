    ...
    static {
        ...
        if (HAS_PRE_CREATURE_SPAWN_EVENT) {
            Skript.registerEvent("Pre Creature Spawn", EvtPreSpawn.class, PreCreatureSpawnEvent.class,
                    "pre [creature] spawn[ing] [of %entitytypes/entitycategories%]")
            ...
            EventValues.registerEventValue(PreCreatureSpawnEvent.class, EntityType.class, new Getter<>() {
                @Override
                public EntityType get(PreCreatureSpawnEvent event) {
